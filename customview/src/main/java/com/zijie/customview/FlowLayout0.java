...
public class FlowLayout0 extends ViewGroup {
    ...
    public FlowLayout0(Context context) {
        this(context, null);
    }

    public FlowLayout0(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayout0(Context context, AttributeSet attrs, int defStyle) {
