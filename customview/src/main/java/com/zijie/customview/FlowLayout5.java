 ...
 * 目前还存在问题，待完善
 */
public class FlowLayout5 extends ViewGroup {
    ...
    public FlowLayout5(Context context) {
        this(context, null);
    }

    public FlowLayout5(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayout5(Context context, AttributeSet attrs, int defStyle) {
